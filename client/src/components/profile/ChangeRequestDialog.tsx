...
export function ChangeRequestDialog({ open, onClose, onSuccess }: ChangeRequestDialogProps) {
        ...
        <div className="flex flex-col gap-4 mt-2">
          ...
          <div className="flex flex-col gap-1.5">
            ...
            <textarea
              ...
              maxLength={500}
              className="flex min-h-[80px] w-full rounded-md border border-base-border bg-base-surface-raised/60 px-4 py-2 text-sm text-base-text shadow-[0_1px_0_rgba(244,237,225,0.04)_inset] transition-all duration-200 placeholder:text-base-text-subtle focus:border-pink-primary/60 focus:bg-base-surface-raised focus:outline-none focus:ring-2 focus:ring-pink-ring focus:ring-offset-0 resize-y"
            />
          </div>

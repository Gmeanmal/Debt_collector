...
export interface paths {
    ...
    "/reference/genders": {
        ...
        /**
         * List all gender taxonomy entries
         * @description Returns the complete ordered list of 72 gender taxonomy entries sorted by `sort_order`. Accessible to all authenticated roles (sub, goddess, admin). Use the `id` from this list to set `gender_id` on a sub profile.
         */
        get: operations["list_genders_reference_genders_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        AvatarKey: "default" | "pink_1" | "pink_2" | "pink_3" | "pink_4" | "dark_1" | "dark_2" | "dark_3" | "accent_1" | "accent_2";
        /** BlacklistEntryOut */
        BlacklistEntryOut: {
            /**
             * Id
        ...
        GenderTaxonomyOut: {
             ...
             * @example a1b2c3d4-0000-5000-8000-000000000001
             */
            id: string;
            /**
             * Slug
             ...
             * @example An umbrella term for gender identities that are neither male nor female.
             */
         ...
         * @enum {string}
         */
        PaymentCategory: "entry" | "rolling" | "weekly_debt" | "debt_payment" | "buyout" | "tribute" | "profile_change_fee" | "wishlist";
        /**
         * PaymentFrequency
         * @enum {string}
         */
         ...
         * @enum {string}
         */
        ProfileChangeRequestStatus: "pending" | "approved" | "rejected" | "awaiting_fee_payment" | "cancelled";
        /** ProfileUpdate */
        ProfileUpdate: {
            /**
             * First Name
            ...
            /**
             * Gender Id
             * @description UUID of the selected gender taxonomy entry (from GET /reference/genders). Written to sub_profile.gender_id.
             * @example null
             */
        ...
        SignupRequest: {
            ...
            /**
             * Gender Id
             * @description UUID of the selected gender taxonomy entry (from GET /reference/genders). Written to sub_profile.gender_id on account creation.
             * @example null
             */
            gender_id?: string | null;
        };
         ...
         * @enum {string}
         */
        ToyCategory: "restraint" | "impact" | "vibrator" | "plug" | "cage" | "gag" | "clothing" | "collar" | "other";
        /** ToyItemCreateIn */
        ToyItemCreateIn: {
            /**
        ...
        UserOut: {
            ...
            /**
             * @description Resolved gender taxonomy entry from sub_profile.gender_id. Null when no taxonomy gender has been selected.
             * @example null
             */
            gender_taxonomy?: components["schemas"]["GenderTaxonomyOut"] | null;
        };
        /**
         * UserRole
         * @enum {string}
...
export interface operations {
    ...
    list_genders_reference_genders_get: {
        parameters: {
            query?: never;
            header?: {
                authorization?: string | null;
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["GenderTaxonomyOut"][];
                };
            };
            /** @description Unauthorized — missing or invalid access token */
            401: {
